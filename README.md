...
* Current MB Branch: [v-2021-04-05](build/musicbrainz/Dockerfile#L50)
...
* To build indexes manually from the installed database:
...
* To download pre-built search indexes based on the latest data dump:
